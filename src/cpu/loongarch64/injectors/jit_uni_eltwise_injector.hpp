...
struct static_params_t {
    ...
    static_params_t(bool save_state = true,
            Xbyak_loongarch64::XReg x_table = Xbyak_loongarch64::XReg(4),
            Xbyak_loongarch64::XVReg p_mask = Xbyak_loongarch64::XVReg(29),
    ...
    bool save_state;
    Xbyak_loongarch64::XReg x_table;
    Xbyak_loongarch64::XVReg p_mask;
    bool is_fwd;
    bool use_dst;
};
...
private:
    ...
    const Xbyak_loongarch64::XReg x_table;
    const Xbyak_loongarch64::XVReg p_mask;
    const bool is_fwd_;
    const bool use_dst_;

    Xbyak_loongarch64::Label l_table;
  ...
  */
    ...
    Vmm table_val(key_t key, Vmm zreg, size_t key_off_val_shift = 0) {
        Xbyak_loongarch64::XReg x_addr(h->X_DEFAULT_ADDR);
